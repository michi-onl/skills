...
export function GlassPill({
  ...
  return <Tag className={`glass-pill ${className}`}>{children}</Tag>;
}
    ...
    <>
      ...
      >
        <div className="glass-navbar__inner">
          ...
          <GlassPill>
            <PillItem ariaLabel="Search" onClick={() => {}}>
              🔍
            </PillItem>
          </GlassPill>
        </div>
      ...
      {/* Mobile bottom bar */}
      <nav
        className="glass-bottombar"
        role="navigation"
        aria-label="Main mobile"
      >
        <GlassPill className="glass-bottombar__pill">
          <PillItem href="/" ariaLabel="Home">
            🏠
          </PillItem>
          <PillItem href="/projects" ariaLabel="Projects">
            📁
          </PillItem>
          <PillItem href="/blog" ariaLabel="Blog">
            📝
          </PillItem>
          <PillItem ariaLabel="Search" onClick={() => {}}>
            🔍
